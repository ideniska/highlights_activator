...
function QuoteListHandler (data) {
    ...
    $.each(data, function (i, row) {
      if (row.comment) {
        $('.col-md-4').append(
          '<div class="card" id="'+row.quote_id+'"><div class="card-header">'+row.book+'</div><div class="card-body"><h5 class="card-title"></h5><p class="card-text"></p>\
          <blockquote class="blockquote mb-0"><p id="quote-text">'+row.text+'</p><footer class="blockquote-footer">'+row.date_added+'<cite title="Source Title"></footer>\
          <div class="comment"><div class="comment-box">'+row.comment+'</div></div><div class="comment-box-buttons">\
          ...
          </div></blockquote><br><div><div class="like-button" style="display: inline-block;"><div id="like">'+showCurrentLike(row.like, row.quote_id)+'</div></div>\
          <div id="fav-delete" data-quoteId="'+row.quote_id+'"style="display: inline-block;"><i class="fa-solid fa-ban"></i></div>\
          ...
          <div class="dropdown" id="fav-dropdown" style="display: inline-block;">\
          <div data-bs-toggle="dropdown" aria-expanded="false" id="dash-share" data-quoteId="'+row.quote_id+'"><i class="fa-solid fa-share-nodes"></i></div><ul class="dropdown-menu"><li>\
          <a class="dropdown-item" href="#">Twitter</a></li><li><a class="dropdown-item" href="#">Facebook</a></li>\
          <li><a class="dropdown-item" href="#">Copy</a></li></ul></div></div></div></div></div></div><br>');
          $(".comment-box").css({
            "visibility" : "visible",
            "height": "100px",
          });
