...
function bookVisibility(visibility, book_id) {
  if (visibility) {
    return '<div><input class="book-switch" data-bookId="' + book_id + '" type="checkbox" id="switch22" checked data-switch="success"/><label for="switch22" data-on-label="Yes" data-off-label="No" class="mb-0 d-block"></label></div>'

  }
  return '<div><input data-bookId="' + book_id + '" type="checkbox" id="switch22" data-switch="success"/><label for="switch22" data-on-label="Yes" data-off-label="No" class="mb-0 d-block"></label></div>'
};
